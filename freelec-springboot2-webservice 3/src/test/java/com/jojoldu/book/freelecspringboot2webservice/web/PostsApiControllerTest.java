...
public class PostsApiControllerTest {
    ...
    @Test
    public void Ports_등록된다() throws Exception {
        //given
        ...
        ResponseEntity<Long> reponseEnitiy = restTemplate.postForEntity(url, requestDto, Long.class);


        //then
        assertEquals(reponseEnitiy.getStatusCode() , HttpStatus.OK);
    ...
    public void Posts_수정된다() throws Exception {
        ...
        //then
        assertEquals(responseEntity.getStatusCode() , HttpStatus.OK); //Http 메서드 확인
